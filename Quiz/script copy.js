...
function finishQuiz() {
  ...
  resultBox.innerHTML = "<h2>Jouw resultaat <br>goede antwoorden " + playerData.goodAnswers + "<br>foute antwoorden " + playerData.wrongAnswers + "</h2>" + " De gene die alles goed hebben wint een prijs. " ;
}
